...
$projects = array(
    // Framestore
        array('Tom and Jerry', 'Framestore', 'Compositor', array('2020'), 1, '-'),
        array('His Dark Materials S2', 'Framestore', 'Compositor', array('2020'), 1, '-'),
        array('A Boy Called Christmas', 'Framestore', 'Compositor', array('2020'), 1, '-'),
        array('No Time To Die', 'Framestore', 'Compositor', array('2020'), 1, '-'),
        array('The Kings Man', 'Framestore', 'Compositor', array('2020'), 1, '-'),
        array('Wonder Woman 1984', 'Framestore', 'Compositor', array('2020'), 1, '-'),   
        array('The Aeronauts', 'Framestore', 'Compositor', array('2019'), 1, '-'),  
        array('Hobbs and Shaw', 'Framestore', 'Compositor', array('2019'), 1, '-'), 
        array('Avengers Endgame', 'Framestore', 'Compositor', array('2019'), 1, '-'),
        array('Detective Pikachu', 'Framestore', 'Compositor', array('2019'), 1, '-'),
    // Milk
        array('Good Omens', 'Milk VFX', 'Compositor', array('2018'), 1, '-'),
    // Jellyfish
        array('Floogals S2', 'Jellyfish Pictures', 'VFX Supervisor', array('2017', '2018'), 1, '-'),
        array('Star Wars : Rogue One', 'Jellyfish Pictures', 'Compositor/Post-Vis', array('2017'), 1, '-'),
        array('Dennis and Gnasher', 'Jellyfish Pictures', 'Pipeline', array('2016'),1, '-'),
        array('Bitz n Bob', 'Jellyfish Pictures', 'Pipeline', array('2016'),1, '-'),
        array('Floogals S1', 'Jellyfish Pictures', 'Lead Compositor + 2D Pipeline', array('2014', '2015', '2016'), 1, '-'),
    // Prime Focus
    ...
    // Cinesite
        array('John Carter', 'Cinesite', 'Stereo', array('2011'), 1, '-'),
    // Nvizible
    ...
    // Nvizible
        array('Clash of The Titans', 'Nvizible', 'Compositor', array('2010'), 1, '-'),
        array('Robin Hood', 'Nvizible', 'Compositor', array('2010'), 1, '-'),
    ...
    // Sprout
        array('Top Gear S13E6', 'Sprout Design', 'Compositor', array('2009'), 1, '-'),
    // LipSync
