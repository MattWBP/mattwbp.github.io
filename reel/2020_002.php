<?php 
    ...
    $strJsonFileContents = file_get_contents("data/breakdown_2020_002_data.json");
    
    // Convert to array 
    $breakdown_data = json_decode($strJsonFileContents, true); 

    // Get the contents of the JSON file 
    $strJsonFileContents = file_get_contents("data/comingsoon_2020_002_data.json");
    // Convert to array 
    ...
    $page_6_data = array_slice($breakdown_data, 13, 1);
