...
json_output = os.path.join(os.path.dirname(__file__), 'breakdown_2020_003_data.json') 
...
shot_breakdowns = {
    ...
    '10_ww1984_sunset':{
        'image': 'img/cropped/half/ww1984_sunset.jpg',
        'project': 'Wonder Woman 1984',
        'shot_name': 'Barbara watches the sunrise',
        'year': '2020',
        'studio': 'Framestore',
        'role': 'Nuke Compositor',
        'supplied elements': [
            'Plate Foreground of character and some FG on Bluescreen.',
            'Lighting Environment render of ocean & small rocks.',
            'DMP of Sky and FG Rocks.'
            ],
        'description': 'Composited all elements.',  
    },
